let a=[
    ...
    //     "techstack":["React","CSS","Data"]
    // },
    {
        "image":"/images/GREAT.png",
        "name":"GREAT - Funds",
        "link":"https://onboarding.appreciatefunds.com/",
        "content":"GREAT - Funds is a multi-tenant, multi-platform application that allows users to manage their funds and investments. It provides a user-friendly interface for users to track their investments.",
        "code":"",
        "techstack":["Python3","Flask","PostgreSQL"]
    },
    {
        "image":"/images/chatapp.png",
        "name":"ChatPlane",
        "link":"https://anshuljain8110.github.io/chatapp/",
        "content":"ChatPlane a App that offers a seamless messaging experience with multimedia support, including images and emojis. Enjoy 24x7 real-time messaging, a user-friendly UI/UX, and the convenience of Google authentication. Available in both dark and light modes, ensures you stay connected and express yourself effortlessly anytime, anywhere.",
        "code":"https://github.com/anshuljain8110/chatapp",
        "techstack":["M.E.R.N","Tailwind","FireBase"]
    },
    {
    ...
    //     "techstack":["React","NewsAPI","BootStrap"]
    // },
    // {
